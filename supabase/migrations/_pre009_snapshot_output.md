...
Captured 2026-09-20T12:52:20Z from **production** (Supabase project `slnphqsrrjpqcthezgun`, PostgreSQL 17.6,
...
Read-only: the whole file ran inside `BEGIN ... ROLLBACK`. Nothing was written.

This is the baseline that `DEPARTMENTS-MASTER-PROMPT.md` section 10 compares against after
migration 009 and again after 010. **If the row counts or `max(updated_at)` below move, the
backfill's trigger suppression failed** and production should be restored from the `pg_dump`
...
|---|---:|---|---|
| `leads` | 3,392 | 2026-09-20 12:29:18.000933+00 | 2026-06-22 10:10:28.680606+00 |
...
| `round_robin_state` | 1 | 2026-09-20 12:29:18.000933+00 | - |
| `webhook_events` | 17,019 | 2026-09-20 12:29:18.000933+00 | 2026-06-22 09:16:19.694676+00 |

**`sales` is empty.** No sale has ever been recorded in production. Consequences worth knowing
before D1: the `sales_renewal_due_date` trigger has never fired against real data, the Renewals
page has never shown a row, and every section 10 check that reads `sales` is trivially satisfied
today. It also means 009's `sales` backfill will touch zero rows.
...
| Columns 009 adds | none exist yet (0 rows returned) |
| Tables 009 creates | none exist yet (0 rows returned) |
...
The cron command is the fact section 10 checks after 009: it must still read
`SELECT public.rag_auto_flag();`. Migration 010 is the only thing permitted to repoint it at
`rag_auto_flag_v2()`.
...
**`product_interested` - 13 distinct values in use:**

| product | leads |
|---|---:|
| (null) | 3,009 |
| Vehicle Video Telematics | 121 |
| Hybrid Car Alarm | 57 |
| Hybrid Dash Cam | 47 |
| Hybrid Car Tracker | 40 |
| Hybrid Pro Max Alarm | 31 |
| Hybrid Pro Tracker | 29 |
| Fuel Monitoring Solution | 20 |
| Hybrid Pro Max Plus Alarm | 11 |
| Anti-Jammer Tracker | 9 |
...
1. **Four leads carry `product_interested = ''`** - an empty string, not NULL. The section 6.3
   coverage query will flag them, because `''` can never have a `department_products` row.
   Section 6.3 is explicit that the config is wrong, not the data: **do not edit those four lead
   rows.** The options are to seed a legacy inactive `''` product, or to treat `''` as NULL in
   the coverage check only. Needs a call before the seed is written.
2. **`Fuel Monitoring Solution` has 20 live telematics leads.** Confirms the decision to leave it
   in the telematics catalogue for history rather than move it to the new department.

## Last-touched ordering (top 20 leads by `updated_at`)

Section 10 requires this list to match row for row after 009. `updated_at` is cast to text in the
query so the values are byte-comparable and timezone-independent. Phone numbers are deliberately
omitted - the ids preserve the ordering, which is the thing being compared.

```
[0] id=00074855-d63c-4e3d-811b-1d8215cd3ce6  updated_at=2026-09-20 12:29:18.000933+00
[1] id=097fcd3f-573b-4b88-a88d-1ae8934557f5  updated_at=2026-09-20 11:57:11.787248+00
